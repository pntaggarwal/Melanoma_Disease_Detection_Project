...
## Conclusions
- In 1st model, The model is overfitting because we can also see difference in loss functions in training & test around the 10-11th epoch
- In 2nd model, There is no improvement in accuracy but we can definitely see the overfitting problem has solved due to data augmentation
- In 3rd model, Accuracy on training data has increased by using Augmentor library
...
## Acknowledgements
Give credit here.
- This project was inspired by currently present rare and highly dangerous disease 


## Contact
Created by [@pntaggarwal] - feel free to contact me!
